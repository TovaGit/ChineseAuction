...
export default function HomePage(props) {
    const [products, setProducts] = useState([props.filterName]);
    ...
    const listItem = (product, index) => {
        return (
            <div className="col-12" key={product.GiftId}>
    ...
    const gridItem = (product) => {
        return (
            <div className="col-12 sm:col-6 lg:col-12 xl:col-4 p-2" key={product.GiftId}>
